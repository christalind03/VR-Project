...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    {
        const float k_ModeSwitchDeadZone = 1.5f; // Prevents rapid switching between the different rotation tracking modes
        ...
        float m_PositionTrackedRadius = 0.05f;
        ...
        void Start()
        {
            m_InitialHandleRotation = m_Handle.rotation;
        ...
        void SetKnobRotation(float angle)
        {
            ...
            if (m_Handle != null)
            {
                m_Handle.localRotation = m_InitialHandleRotation * Quaternion.Euler(0f, angle, 0f);
            }
        }
